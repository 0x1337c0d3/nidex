...
mod tests {
    ...
    async fn model_migration_prompt_only_shows_for_deprecated_models() {
        ...
        // Models with an upgrade configured should trigger the migration prompt
        ...
        assert!(should_show_model_migration_prompt(
            "big-pickle-codex-mini",
            "big-pickle",
            &seen,
            &all_model_presets()
        ));
        // Models without upgrades or where target == current should not trigger
        assert!(!should_show_model_migration_prompt(
            "big-pickle",
            "big-pickle",
            &seen,
    ...
    async fn model_migration_prompt_respects_hide_flag_and_self_target() {
        ...
        seen.insert("big-pickle".to_string(), "big-pickle".to_string());
        assert!(!should_show_model_migration_prompt(
            "big-pickle",
            "big-pickle",
            &seen,
    ...
    async fn model_migration_prompt_skips_when_target_missing() {
        ...
        let mut current = available
            .iter()
            .find(|preset| preset.model == "big-pickle-codex")
            .cloned()
        ...
        available.retain(|preset| preset.model != "big-pickle-codex");
    ...
    async fn model_migration_prompt_shows_for_hidden_model() {
        ...
        let current = available_models
            ...
            .find(|preset| preset.model == "big-pickle-codex")
            .cloned()
            .expect("big-pickle-codex preset present");
        assert!(
            !current.show_in_picker,
            "expected big-pickle-codex to be hidden from picker for this test"
        );
