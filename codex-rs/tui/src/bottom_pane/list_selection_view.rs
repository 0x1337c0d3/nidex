...
mod tests {
    ...
    fn width_changes_do_not_hide_rows() {
        ...
        let items = vec![
            SelectionItem {
                ...
                description: Some("Gemma-4 model.".to_string()),
                dismiss_on_select: true,
                ..Default::default()
            },
            SelectionItem {
                name: "big-pickle".to_string(),
                description: Some("big-pickle model.".to_string()),
                dismiss_on_select: true,
                ..Default::default()
            },
            SelectionItem {
                name: "big-pickle-codex".to_string(),
                description: Some("big-pickle-codex model.".to_string()),
                dismiss_on_select: true,
                ..Default::default()
            },
        ];
    ...
    fn snapshot_model_picker_width_80() {
        ...
        let items = vec![
            SelectionItem {
                name: "gemma-4".to_string(),
                description: Some("Gemma-4.".to_string()),
                dismiss_on_select: true,
                ..Default::default()
            },
            SelectionItem {
                name: "big-pickle".to_string(),
                description: Some("big pickle.".to_string()),
                dismiss_on_select: true,
                ..Default::default()
            },
        ];
