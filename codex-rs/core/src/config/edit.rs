...
mod tests {
    ...
    fn blocking_set_model_top_level() {
        ...
        let expected = r#"model = "big-pickle"
...
"#,
        ...
        apply_blocking(
            ...
            None,
            &[ConfigEdit::SetNoticeHideModelMigrationPrompt(
                "hide_big-pickle_migration_prompt".to_string(),
                true,
            )],
        )
        .expect("persist");
        ...
        let expected = r#"[notice]
existing = "value"
hide_big-pickle_migration_prompt = true
"#;
        assert_eq!(contents, expected);
    }
...
"#,
        ...
        apply_blocking(
            ...
            &[ConfigEdit::RecordModelMigrationSeen {
                from: "big-pickle".to_string(),
                to: "big-pickle".to_string(),
            }],
        )
        .expect("persist");
...
"#;
        ...
        let updated_expected = r#"model = "big-pickle"
model_reasoning_effort = "high"
"#;
        ConfigEditsBuilder::new(codex_home)
            .set_model(Some("big-pickle"), Some(ReasoningEffort::High))
