...
#[ignore = "unknown custom tool error message format changed; needs test update"]
...
#[ignore = "shell escalated permissions response format changed; needs test update"]
#[tokio::test(flavor = "multi_thread", worker_threads = 2)]
...
#[ignore = "shell timeout output format changed; needs test update"]
#[tokio::test(flavor = "multi_thread", worker_threads = 2)]
